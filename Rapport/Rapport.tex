...
\begin{titlepage}
    \thispagestyle{empty}
    \centering
    \vspace*{-1.5cm}  % Negative space to pull everything up
    
    % School logo with perfect top margin
    \includegraphics[height=5cm]{./imgs/ESTLogo.jpg}\\
    ...
    ÉCOLE SUPÉRIEURE DE TECHNOLOGIE DE SAFI\\[0.2cm] % More space before department
