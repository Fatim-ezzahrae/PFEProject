...
\begin{titlepage}
    ...
    \textbf{Département Informatique}\\[0.1cm]
...
\vspace*{-2cm} % Adjust this value to move content up
...
\vspace*{-0.3cm} % Adjust this to control space after list
...
\section*{Références}
\vspace*{1cm} 
\begin{itemize}[topsep=6cm, itemsep=6pt, partopsep=0pt, parsep=0pt]
    \item https://uiverse.io/ \\
    consulter le : 2, 3, 8, 9, 17, 21 mars.
    \item https://fonts.google.com/  \\
    consulter le : 18, 20, 22 février.
    \item https://fontawesome.com/ \\
    consulter le : 18, 22, 24 février. 
    \item https://www.logoai.com/ \\
    consulter le : 13, 17, 25 février.
    \item https://coolors.co/ \\
    consulter le : 24 février.
    \item https://www.youtube.com/@NetNinja \\
    consulter le : 1\textsuperscript{er} mars.
